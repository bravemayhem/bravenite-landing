...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-blue-950 to-blue-900 relative overflow-hidden">
      ...
      {/* Navigation Menu */}
      <header>
        <nav className="fixed top-0 left-0 right-0 z-[100] backdrop-blur-lg bg-black/30 border-b border-blue-500/20">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between h-16">
              <div className="flex items-center">
                <span className="text-lg font-bold text-white cursor-pointer" onClick={scrollToTop}>Bravenite</span>
              </div>
